...
class ChapterController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request -> validate(
            ...
            [
                'slug_chapter.unique' => 'Slug đã tồn tại.Vui lòng chọn tên khác!!!',
                'tieude.unique' => 'Tiêu đề đã tồn tại.Vui lòng chọn tên khác!!!',
                'tieude.required' => 'Tiêu đề đang để trống',
                'noidung.required' => 'Tiêu đề đang để trống',
                'tomtat.required' => 'Mô tả đang để trống',
                'slug_chapter.required'=>'Thiếu slug truyện',
            ]
        );
